...
public final class AgentsStartAnyStep extends Hilo {
    ...
    public AgentsStartAnyStep(JTextArea caja, String email, String password, String nombre, String apellidoP, String apellidoM, String tipoU, int numberRequest, String ip) {
        this.caja = caja;
        this.email = email;
    ...
    public void userCreation(String token, String session, double randomNumber) {
        ...
        try {
            ...
            String rootCreation = "curl -d \"email=" + email + "&"
                    ...
                    + "-X POST http://52.202.214.13:80/userCreation";
